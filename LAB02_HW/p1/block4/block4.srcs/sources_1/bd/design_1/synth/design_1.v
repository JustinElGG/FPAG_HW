...
module design_1
   (clk,
    ...
    led4_r,
    rst);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_RESET rst, CLK_DOMAIN design_1_clk, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0.000" *) input clk;
  ...
  wire [7:0]FSM_Decoder_0_B_time_out;
  wire [7:0]FSM_Decoder_0_G_time_out;
  wire [7:0]FSM_Decoder_0_R_time_out;
  ...
  assign clk_1 = clk;
  assign led4_b = RGB_LED_0_B_out;
  assign led4_g = RGB_LED_0_G_out;
  assign led4_r = RGB_LED_0_R_out;
  assign rst_1 = rst;
  design_1_FSM_Decoder_0_0 FSM_Decoder_0
       (.B_time_out(FSM_Decoder_0_B_time_out),
        .G_time_out(FSM_Decoder_0_G_time_out),
        .R_time_out(FSM_Decoder_0_R_time_out),
        .clk(divider_0_clk_div),
        .rst(rst_1));
  design_1_RGB_LED_0_0 RGB_LED_0
       (.B_out(RGB_LED_0_B_out),
        .B_time_in(FSM_Decoder_0_B_time_out),
        .G_out(RGB_LED_0_G_out),
        .G_time_in(FSM_Decoder_0_G_time_out),
        .R_out(RGB_LED_0_R_out),
        .R_time_in(FSM_Decoder_0_R_time_out),
        .clk(clk_1),
        .rst(rst_1));
