...
HD_PWD='D:/FPGA/LAB02_HW/p1/block4/block4.runs/design_1_FSM_Decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FSM_Decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FSM_Decoder_0_0.tcl
